...
### 🔹 F1-score по классам
![F1-score по классам](./F1%20score%281%29.png)
...
![Precision по классам](./precission%20%28real%29.png)
...
![Recall по классам](./recall%20%281%29.png)
...
- 🎯 Выбор в пользу **RuBERT** обоснован в задачах, где важна полнота и адекватное покрытие классов.
- 
